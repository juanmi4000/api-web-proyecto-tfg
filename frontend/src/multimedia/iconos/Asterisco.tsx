...
export function AsteriscoReact ({ clases }: Props): JSX.Element {
  return (
    <svg className={clases} aria-label='Asterisco, representa información adicional' viewBox='0 0 24 24' fill='currentColor'>
